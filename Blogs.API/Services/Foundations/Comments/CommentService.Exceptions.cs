...
namespace Blogs.API.Services.Foundations.Comments
{
    public partial class CommentService
    {
        ...
        private ValueTask<Comment> TryCatch(Operation<ValueTask<Comment>> operation) =>
            WithTracing(async () =>
            {
                return await WithRollback(async () =>
                {
                    ...
                    catch (DbUpdateException databaseUpdateException)
                    {
                        ...
                        throw CreateAndLogDependencyException(failedCommentStorageException);
                    }
        ...
        private CommentDependencyException CreateAndLogDependencyException(
            Xeption exception)
        {
            var commentDependencyException = new CommentDependencyException(exception);
